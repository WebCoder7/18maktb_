  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Nima uchun 18-Maktab ?</h2>
            <div className='row g-4'>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                Eng ko'p olinga kuboklar
                            </Card.Title>
                            <Card.Text className='text-center'>
                            Sportda yoki boshqa musobaqalarda eng ko'p qo'lga kiritilgan kuboklar bir necha sohalarda mashhur. Keling, ayrim sport turlari va musobaqalar bo'yicha eng ko'p qo'lga kiritilgan kuboklarga misolla
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                Biz talabalarimizni xursand qilamiz
                            </Card.Title>
                            <Card.Text className='text-center'>
                            Talabalaringizni xursand qilish uchun turli usullarni sinab ko'rishingiz mumkin. Bu nafaqat ularning bilim olish jarayonini qiziqarli qiladi, balki motivatsiyasini oshirishga ham yordam beradi.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Umumiy o'rta ta'lim maktabi.  Toshkent viloyati, Olmaliq shahri. 1-sinfdan 11-sinfgacha bo'lgan o'quvchilarga umumiy ta'lim berish. Tajribali pedagoglar o'quvchiga  yaxshi va kuchli ta'lim beradi. 
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
